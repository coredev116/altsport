...
export default class FDRIFTAthletes extends Base {
  ...
  // @ApiProperty({ name: "providerEntryId", type: "string", example: "10003" })
  // @Column({ type: "text", nullable: true })
  // providerEntryId: string;

  @ApiProperty({ name: "startNumber", type: "string", example: "24" })
  @Column({ type: "text", nullable: true })
  startNumber: string;
