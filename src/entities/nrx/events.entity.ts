...
import { EventStatus, SportsDbSchema, NRXEventCategoryType } from "../../constants/system";
...
export default class WRXEvents extends Base {
  @ApiProperty({
    name: "tourYearId",
    type: "string",
  ...
  @Column({ type: "text" })
  categoryName: NRXEventCategoryType | string;
