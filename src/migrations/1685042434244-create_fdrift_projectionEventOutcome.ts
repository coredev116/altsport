...
const tableName = `${SportsDbSchema.FDRIFT}.projectionEventOutcome`;

export class createFdriftProjectionEventOutcome1685042434244 implements MigrationInterface {
