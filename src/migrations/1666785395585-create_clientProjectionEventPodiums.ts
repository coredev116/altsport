...
const tableName = `${SportsDbSchema.NRX}.clientProjectionEventPodiums`;

export class createClientProjectionEventPodium1666785395585 implements MigrationInterface {
