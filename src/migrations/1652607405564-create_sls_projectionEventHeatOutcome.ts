...
const tableName = `${SportsDbSchema.SLS}.projectionEventHeatOutcome`;

export class createSlsProjectionEventHeatOutcome1652607405564 implements MigrationInterface {
