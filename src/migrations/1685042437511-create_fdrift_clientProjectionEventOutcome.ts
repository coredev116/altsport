...
const tableName = `${SportsDbSchema.FDRIFT}.clientProjectionEventOutcome`;

export class createFdriftClientProjectionEventOutcome1685042437511 implements MigrationInterface {
