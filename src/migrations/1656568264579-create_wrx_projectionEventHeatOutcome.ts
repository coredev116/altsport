...
const tableName = `${SportsDbSchema.NRX}.projectionEventHeatOutcome`;

export class createWrxProjectionEventHeatOutcome1656568264579 implements MigrationInterface {
