...
const tableName = `${SportsDbSchema.MOTOCRS}.projectionEventPodiums`;

export class createMotocrsProjectionEventPodiums1684995944067 implements MigrationInterface {
