...
const tableName = `${SportsDbSchema.MOTOCRS}.clientProjectionEventOutcome`;

export class createMotocrsClientProjectionEventOutcome1684995946071 implements MigrationInterface {
