...
const tableName = `${SportsDbSchema.SPR}.projectionEventHeatOutcome`;

export class createSprProjectionEventHeatOutcome1669617077548 implements MigrationInterface {
