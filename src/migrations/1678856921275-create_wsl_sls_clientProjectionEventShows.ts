...
const wslTableName = `${SportsDbSchema.WSL}.clientProjectionEventShows`;
const slsTableName = `${SportsDbSchema.SLS}.clientProjectionEventShows`;
...
export class createWslSlsClientProjectionEventShows1678856921275 implements MigrationInterface {
