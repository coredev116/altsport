...
const tableName = `${SportsDbSchema.MOTOCRS}.clientProjectionEventPodiums`;

export class createMotocrsClientProjectionEventPodium1684995957067 implements MigrationInterface {
