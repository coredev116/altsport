...
const wslTableName = `${SportsDbSchema.WSL}.projectionEventPodiums`;
const slsTableName = `${SportsDbSchema.SLS}.projectionEventPodiums`;
...
export class createWslSlsProjectionEventPodiums1678771397511 implements MigrationInterface {
