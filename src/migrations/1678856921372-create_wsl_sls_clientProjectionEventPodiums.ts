...
const wslTableName = `${SportsDbSchema.WSL}.clientProjectionEventPodiums`;
const slsTableName = `${SportsDbSchema.SLS}.clientProjectionEventPodiums`;
...
export class createWslSlsClientProjectionEventPodiums1678856921372 implements MigrationInterface {
