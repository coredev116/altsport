...
const tableName = `${SportsDbSchema.MOTOCRS}.projectionEventOutcome`;

export class createMotocrsProjectionEventOutcome1684995943887 implements MigrationInterface {
