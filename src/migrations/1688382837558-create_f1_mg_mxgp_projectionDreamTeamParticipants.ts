...
const mxgpTableName = `${SportsDbSchema.MXGP}.projectionDreamTeamParticipants`;
const f1TableName = `${SportsDbSchema.F1}.projectionDreamTeamParticipants`;
const mgTableName = `${SportsDbSchema.MotoGP}.projectionDreamTeamParticipants`;
...
export class CreateF1MgMxgpProjectionDreamTeamParticipants1688382837558
    ...
    await Promise.all([
      queryRunner.createForeignKeys(mxgpTable, [
        new TableForeignKey({
          ...
          referencedTableName: "projectionDreamTeam",
