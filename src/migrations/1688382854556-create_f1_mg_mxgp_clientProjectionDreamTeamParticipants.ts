...
const mxgpTableName = `${SportsDbSchema.MXGP}.clientProjectionDreamTeamParticipants`;
const f1TableName = `${SportsDbSchema.F1}.clientProjectionDreamTeamParticipants`;
const mgTableName = `${SportsDbSchema.MotoGP}.clientProjectionDreamTeamParticipants`;
...
export class CreateF1MgMxgpProjectionDreamTeamParticipants1688382854556
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await Promise.all([
      queryRunner.createForeignKeys(mxgpTable, [
        new TableForeignKey({
          columnNames: ["dreamTeamId"],
          referencedColumnNames: ["id"],
          referencedTableName: "clientProjectionDreamTeam",
