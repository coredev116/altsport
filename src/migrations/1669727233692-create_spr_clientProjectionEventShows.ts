...
const tableName = `${SportsDbSchema.SPR}.clientProjectionEventShows`;

export class createSprClientProjectionEventShows1669727233692 implements MigrationInterface {
