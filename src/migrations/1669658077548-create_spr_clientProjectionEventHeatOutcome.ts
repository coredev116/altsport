...
const tableName = `${SportsDbSchema.SPR}.clientProjectionEventHeatOutcome`;

export class createSprClientProjectionEventHeatOutcome1669658077548 implements MigrationInterface {
