...
const tableName = `${SportsDbSchema.MOTOCRS}.projectionEventHeatOutcome`;

export class createMotocrsProjectionEventHeatOutcome1684995944052 implements MigrationInterface {
