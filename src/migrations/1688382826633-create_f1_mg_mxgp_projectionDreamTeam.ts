...
const mxgpTableName = `${SportsDbSchema.MXGP}.projectionDreamTeam`;
const f1TableName = `${SportsDbSchema.F1}.projectionDreamTeam`;
const mgTableName = `${SportsDbSchema.MotoGP}.projectionDreamTeam`;
...
export class CreateF1MgMxgpProjectionDreamTeam1688382826633 implements MigrationInterface {
