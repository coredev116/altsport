...
const tableName = `${SportsDbSchema.SPR}.clientProjectionEventPodiums`;

export class createSprClientProjectionEventPodiums1669787142172 implements MigrationInterface {
