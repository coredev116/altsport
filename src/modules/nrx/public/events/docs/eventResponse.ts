...
class EventRoundListing {
  ...
  @ApiProperty({ name: "roundStatus", type: "string", required: true, example: "COMPLETED" })
  roundStatus: string;
...
export default class EventResponse {
  ...
  @ApiProperty({ name: "eventStatus", type: "string", example: "UPCOMING" })
  eventStatus: string;

  @ApiProperty({ name: "eventLocation", type: "string", example: "Canterbury, UK" })
  eventLocation: string;

  @ApiProperty({ name: "eventLocationGroup", type: "string", example: "Canterbury, UK" })
