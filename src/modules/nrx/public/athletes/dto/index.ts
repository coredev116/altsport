...
import { API_SORT_ORDER, NRXEventCategoryType } from "../../../../../constants/system";
...
export class AthleteListing {
  ...
  @IsOptional()
  @IsEnum(NRXPublicStatsSortColumns)
  @IsString()
  public sortColumn: NRXPublicStatsSortColumns = NRXPublicStatsSortColumns.ATHLETE;
