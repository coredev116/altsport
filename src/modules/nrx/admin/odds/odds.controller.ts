...
import { UpdateEventOddDto, EventOddsDto, UpdateEventHeatOddDto } from "./dto/odds.dto";
...
import { UpdateHeatVoidedParams, EventIdParamDto } from "./dto/params.dto";
...
@ApiTags("odds")
@Controller({
  path: `admin/${SportsTypes.RALLYCROSS}/events`,
})
export class OddsController {
  ...
  @Sse("odds/sse")
  sse() {
    return fromEvent(this.eventEmitter, `${SportsTypes.RALLYCROSS}OddEvent`);
  }
    ...
    eventOdds.forEach((eventOdd) => {
      ...
      if (!heat) {
        ...
        roundObj[eventOdd.heat.round.id].heats.push({
          ...
          traderUpdatedAtDate: eventOdd?.updatedAt || null,
          athletes: [
            {
              id: eventOdd.participant.athlete.id,
