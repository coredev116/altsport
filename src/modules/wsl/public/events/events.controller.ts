...
@ApiTags("Events")
@Controller({
  path: `${SportsTypes.SURFING}/events`,
})
export default class EventController {
  ...
  @ApiQuery({
    ...
    type: "string",
    required: false,
    description: "Event Name for which the tour array is to be returned",
  })
  @ApiResponse({
    description: "Success",
  ...
  public async getEventByName(@Query() queryParams: EventByNameYearDto) {
    const event = await this.eventService.getEvent(null, queryParams.year, queryParams.eventName);
  ...
  public async fetchEventDetails(@Param() params: EventIdParamDto) {
