...
class ScoresLegacy {
  ...
  @ApiProperty({ name: "goals", type: "integer", example: 1 })
  goals: number;
}
...
class EventRoundsLegacy {
  ...
  @ApiProperty({
    type: ScoreRoundsLegacy,
    required: true,
  })
  round: ScoreRoundsLegacy;
}
...
class EventLegacy {
  ...
  @ApiProperty({
    type: EventRoundsLegacy,
    isArray: true,
  })
  eventRounds: EventRoundsLegacy[];
...
export class SummaryMatchesLegacy {
  @ApiProperty({ name: "homeTeam", type: "string", example: "Strykers" })
  homeTeam: string;

  @ApiProperty({ name: "homeTeamGoals", type: "integer", example: 5 })
  homeTeamGoals: number;

  @ApiProperty({ name: "awayTeam", type: "string", example: "Sidekicks" })
  awayTeam: string;
...
export class SummaryLegacy {
  ...
  @ApiProperty({
    type: SummaryMatchesLegacy,
    isArray: true,
  })
  matches: SummaryMatchesLegacy[];
}
...
export class MASLEventsResponseLegacy {
  @ApiProperty({
    type: SummaryLegacy,
  })
